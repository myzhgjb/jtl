$(function() {
  // 添加提示框
  $.tooltipStart();
  var $business9410 = $("#business9410Check");
  
  // 返回按钮
  $business9410.closeAdd(function() {
	$('#modifybusiness9410from').formValidation('disableSubmitButtons', false)
	    .formValidation('resetForm', true);
  });
  
  
  // addbusiness9410form
  $business9410.find("#modifybusiness9410from").formValidationExtend(
	  {
	    'data' : {
		  validators : {
		    callback : {
	  ...
	  function() {
		// ID
		var id = $business9410.find("#modifybusiness9410from").attr("ref");
		...
		var tbPfkOutletLongitude = $.trim($business9410.find("#tbPfkOutletLongitude").val());
	    ...
	    $.post(contextpath + "/rest/business9410/updatebusiness9410", {
	    	"id":id,
	    	"tbEquipId" : tbEquipId,
	    	"tbLabel" : tbLabel,
